...
{\normalsize GitHub Repo: https://github.com/Akshat-A-K/Resumer-Parser}
\end{center}
...
\section{Screenshots}
Below we include two key screenshots from the Streamlit app. These will be added in a two-column layout.

\begin{center}
\begin{minipage}[t]{0.48\textwidth}
\centering
\fbox{\parbox[c][4cm][c]{0.9\textwidth}{\centering Screenshot 1 placeholder}}
\\[4pt]
\small Parse One Resume mode
\end{minipage}
\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
\fbox{\parbox[c][4cm][c]{0.9\textwidth}{\centering Screenshot 2 placeholder}}
\\[4pt]
\small Evaluate Quality mode
\end{minipage}
\end{center}
...
\bibitem{dataset}
Resume Entities for NER Dataset, Kaggle.\newline
